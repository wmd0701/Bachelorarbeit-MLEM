...
// forward/backward projection implementing Coalesced Brutal Warp SpMV
...
__global__ void calcBwProj_coalesced_brutal_warp(unsigned int *csr_Rows_Trans, unsigned int *csr_Cols_Trans, float *csr_Vals_Trans, float *correl, float *bwproj, unsigned int cols);
...
// helper function for Coalesced Brutal Warp SpMV
